...
def process_song_file(cur, filepath):
    ...
    @param filepath: the path to the songs file
    @param filepath: the path to the artists file
    """
    # open song file
...
def process_log_file(cur, filepath):
    ...
    time_data = pd.DataFrame({"timestamp": t, "hour": t.dt.hour, "day": t.dt.day, "week": t.dt.week, "month": t.dt.month, "year": t.dt.year, "weekday": t.dt.weekday})
    time_df = time_data
